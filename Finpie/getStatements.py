...
def download(copy,stopPos):
    max_errors = 5 #how many errors in a row before program thinks it's a connection problem
    ...
    source_file = "Missing Symbols.txt" #which source to download tickers from
    ...
    Symbols = np.loadtxt(text_path+source_file,dtype='str').tolist()
